...
//		z *= FREQUENCY_MODIFIER;
		...
		float heightL = getHeight(x - 6.66f, z);
		float heightR = getHeight(x + 6.66f, z);
		float heightD = getHeight(x, z - 6.66f);
		float heightU = getHeight(x, z + 6.66f);
...
//		Vector3f temp = new Vector3f(-0.1f, 0.5f, -0.1f);
//		return temp;
	}
