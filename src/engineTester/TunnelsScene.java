...
public class TunnelsScene {
	...
	public static void main(String[] args) {
		...
		List<Vector3f> roadWaypoints = findPath(domainLowerLeftLimit, domainUpperRightLimit, heightGenerator, true, 15f, 10, 8, 4500f, 6000f, 100, false, random);
		...
		TunnelManager tunnelManager = new TunnelManager(road, pathfinder.findTunnelsData(), 10, 1.0f,
				50f, 50f, 50f, 50f, 50f, 50f, "tunnel", "tunnel", "tunnel", "black", loader);
