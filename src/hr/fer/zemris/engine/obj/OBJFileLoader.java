...
public class OBJFileLoader {
	...
	private static final Logger LOGGER = Logger.getLogger(OBJFileLoader.class.getName());
    ...
    public static ModelData loadOBJ(String objFileName, boolean moveToOrigin,
        ...
        String path = Globals.RESOURCES_ROOT + objFileName + FILE_EXTENSION;
        List<String> lines = null;
		try {
			lines = Files.readAllLines(Paths.get(path));
		} catch (IOException e) {
			LOGGER.severe("Problem reading file: " + path + ".");
