...
public class MountainScene {
	...
	public static void main(String[] args) {
		...
		Pathfinder pathfinder = new Pathfinder(
				...
				domainLowerLeftLimit, domainUpperRightLimit, heightGenerator, 100f, // cellSize
				false, // allowTunnels
...
//		);
		...
		// tunnels allowed, no tunnel neighborhood limiting
//		Pathfinder pathfinder = new Pathfinder(AStar<Point2Di>::new, // algorithm
//				CatmullRomSpline3D::new, // spline
//				new Point2Df(6000f, -21560f), // start,
//				new Point2Df(11580f, -7130f), // goal,
//				domainLowerLeftLimit, domainUpperRightLimit, heightGenerator, 100f, // cellSize
...
//		);
		...
		// tunnels allowed, limit number of tunnel successors
//		Pathfinder pathfinder = new Pathfinder(AStar<Point2Di>::new, // algorithm
//				CatmullRomSpline3D::new, // spline
//				new Point2Df(6000f, -21560f), // start,
//				new Point2Df(11580f, -7130f), // goal,
...
//		);
		...
		pathfinder.findModifierTrajectories(-0.05f)
		...
		TerrainLODGrid terrainLODGrid = new TerrainLODGrid(distanceToLODLevel, lodLevelToVertsPerUnit, patchSize,
				texWidth, texDepth, new Vector3f(), loader, texturePack, blendMap, heightGenerator, biomesMap,
				domainLowerLeftLimit, domainUpperRightLimit, Optional.of(Globals.getThreadPool()));
