...
public class Medvednica {
	...
	public static void main(String[] args) {
		...
		List<Range> textureRanges = Arrays.asList(new Range(0, 600), new Range(600, 900),
				new Range(900, heightGenerator.getMaxHeight()));
		...
		Pathfinder pathfinder = new Pathfinder(
				...
				domainLowerLeftLimit, domainUpperRightLimit, heightGenerator, 15f, // cellSize
				false, // allowTunnels
...
//				new Point2Df(9350f, 11950f), // start,
//				new Point2Df(4000f, 0f), // goal,
//				domainLowerLeftLimit, domainUpperRightLimit, heightGenerator, 50f, // cellSize
//				false, // allowTunnels
//				15f, // minimum tunnel depth
//				10, // endpointOffset
//				8, // maskOffset
